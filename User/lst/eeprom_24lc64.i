#line 1 "..\\BSP_Lib\\Src\\NUC1xx-LB_002\\EEPROM_24LC64.c"
...
#line 7 "..\\BSP_Lib\\Src\\NUC1xx-LB_002\\EEPROM_24LC64.c"
...
#line 8 "..\\BSP_Lib\\Src\\NUC1xx-LB_002\\EEPROM_24LC64.c"
...
#line 9 "..\\BSP_Lib\\Src\\NUC1xx-LB_002\\EEPROM_24LC64.c"
...
#line 10 "..\\BSP_Lib\\Src\\NUC1xx-LB_002\\EEPROM_24LC64.c"
...
#line 11 "..\\BSP_Lib\\Src\\NUC1xx-LB_002\\EEPROM_24LC64.c"
#line 1 "..\\BSP_Lib\\Inc\\NUC1xx-LB_002\\EEPROM_24LC64.h"


     
extern void Write_24LC64(uint32_t address,uint8_t data);
extern uint8_t Read_24LC64(uint32_t address);
#line 12 "..\\BSP_Lib\\Src\\NUC1xx-LB_002\\EEPROM_24LC64.c"
...
void Write_24LC64(uint32_t address,uint8_t data )
{
	...
	((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->DATA = 0XA0;					
    DrvI2C_Ctrl(I2C_PORT1, 0, 0, 1, 0); 
    while( ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.SI == 0 );		    
	
	((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->DATA = (address>>8)&0XFF;	
	DrvI2C_Ctrl(I2C_PORT1, 0, 0, 1, 1); 
	while( ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.SI == 0 );			
	
	((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->DATA = address&0XFF;	
	DrvI2C_Ctrl(I2C_PORT1, 0, 0, 1, 1); 
	while( ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.SI == 0 );			
	
	((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->DATA = data;					
	DrvI2C_Ctrl(I2C_PORT1, 0, 0, 1, 1); 
	while( ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.SI == 0 );			
...
uint8_t Read_24LC64(uint32_t address)
{
	...
	((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->DATA = 0XA1;
	DrvI2C_Ctrl(I2C_PORT1, 0, 0, 1, 1);    
    while( ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.SI == 0 );			   

	
	((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->DATA = 0XFF;
	DrvI2C_Ctrl(I2C_PORT1, 0, 0, 1, 0);    
	while( ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.SI == 0 );			   
	TEMP= ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->DATA;
