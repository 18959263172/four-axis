#line 1 "..\\BSP_Lib\\Src\\Driver\\DrvCAN.c"
...
#line 7 "..\\BSP_Lib\\Src\\Driver\\DrvCAN.c"

 
 
 
#line 1 "..\\BSP_Lib\\Inc\\Driver\\DrvCAN.h"
...
#line 11 "..\\BSP_Lib\\Inc\\Driver\\DrvCAN.h"
...
typedef enum 
{
	DRVCAN_INT_RI  =  0x00000001,	      
	DRVCAN_INT_TI  =  0x00000002,		  
	DRVCAN_INT_WUI =  0x00000010,
	DRVCAN_INT_ALI =  0x00000040,
	DRVCAN_INT_BEI =  0x00000080
...
#line 12 "..\\BSP_Lib\\Src\\Driver\\DrvCAN.c"
...
#line 13 "..\\BSP_Lib\\Src\\Driver\\DrvCAN.c"
#line 14 "..\\BSP_Lib\\Src\\Driver\\DrvCAN.c"
...
{
    uint32_t status;
	status  = (*((volatile unsigned int *)(&((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->INTR)));
	 	
	if(((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->INTR.BEI ==1)								 
	{
		((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->INTR.BEI =1 ; 							 			

    	if (CANHandler.BusErrorCallBackFn)				  
		{
	...
	if(((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->INTR.ALI ==1)		 
	{
		((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->INTR.ALI =1 ; 						   	 

		if (CANHandler.ArbitLostCallBackFn)				 
		{
	...
	if(((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->INTR.WUI ==1)		 
	{												  	
		((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->CMD.WAKEUP_EN = 0; 						
 
		((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->INTR.WUI =1 ; 						  	 
	...
	if(((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->INTR.TI ==1)	 	 
	{
		((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->INTR.TI =1 ; 							   	 

		if (CANHandler.TransmitCallBackFn)				 
		{
	...
	if(((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->INTR.RI ==1)		 
	{
		((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->INTR.RI =1 ; 							  	 

		if (CANHandler.ReceiveCallBackFn)				 
		{
...
int32_t DrvCAN_Open(int32_t i32CANKiloBitRate,int16_t i16SamplePointPos)
{
	...
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->CMD.CAN_EN 		= 1;
...
STR:		
	...
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->BTIMR.TSEG1 = i32TSEG1;

	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->BTIMR.TSEG2 = i32TSEG2;
...
int32_t DrvCAN_Close()
{
	...
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->CMD.CAN_EN =0;
...
int32_t DrvCAN_Write(STR_CAN_T *Msg)
{
	...
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->TXFINFO.TXFF 		= Msg->u8cFormat;

	 
	if(Msg->u8cFormat ==1 )  
		((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->TXIDR.TXID 	= Msg->id;							
	else
		((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->TXIDR.TXID 	= (Msg->id)<<18;							
		
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->TXFINFO.TXDLC		= Msg->u8cLen;
	
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->TXDATA[0] 		= Msg->u32cData[0];
		
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->TXDATA[1] 		= Msg->u32cData[1];
		
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->TXFINFO.TXRTR 	= Msg->u8cType;

	 
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->CMD.TXREQ = 1; 
...
STR_CAN_T DrvCAN_Read(void)
{
	...
	recCAN.u8cLen 		= ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->RXFINFO.RXDLC; 
	recCAN.u8cFormat	= ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->RXFINFO.RXIDE; 
	if(recCAN.u8cFormat==1)   
		recCAN.id 		= ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->RXIDR.RXID;
	else
		recCAN.id 		= (((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->RXIDR.RXID)>>18;
	
	recCAN.u8cType		= ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->RXFINFO.RXRTR; 

	recCAN.u32cData[0] 	= ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->RX_DATA[0] ; 
	recCAN.u32cData[1] 	= ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->RX_DATA[1] ; 
...
int32_t DrvCAN_EnableInt(uint32_t u32InterruptSrc)
{
	...
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->INTEN.BEIE		=(u32InterruptSrc & DRVCAN_INT_BEI)?1:0 ;
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->INTEN.ALIE		=(u32InterruptSrc & DRVCAN_INT_ALI)?1:0;
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->INTEN.WUIE		=(u32InterruptSrc & DRVCAN_INT_WUI)?1:0;
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->INTEN.TIE			=(u32InterruptSrc & DRVCAN_INT_TI)?1:0;
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->INTEN.RIE			=(u32InterruptSrc & DRVCAN_INT_RI)?1:0;

	if(u32InterruptSrc&DRVCAN_INT_WUI)				 
	 	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->CMD.WAKEUP_EN = 1; 
	...
	switch(Type)
   	{
       	case TYPE_BEI:
       	{
			CANHandler.BusErrorCallBackFn = 0;
       		break;
		}
       	case TYPE_ALI:
       	{
			CANHandler.ArbitLostCallBackFn = 0;
       		break;
		}
       	case TYPE_WUI:
       	{
       	...
       	case TYPE_TI:
       	{
			CANHandler.TransmitCallBackFn = 0;
       		break;
		}
       	case TYPE_RI:
       	{
			CANHandler.ReceiveCallBackFn = 0;
       		break;
		}
	}
	return ;
...
int32_t DrvCAN_DisableInt(uint32_t u32InterruptSrc)
{
	...
	*((volatile unsigned int *)(&((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->INTEN))=(*((volatile unsigned int *)(&((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->INTEN)))&~u32InterruptSrc;
...
int32_t DrvCAN_GetErrorStatus(E_DRVCAN_ERRFLAG u32ErrorFlag)
{
	...
	switch(u32ErrorFlag)
	{
		case DRVCAN_ERRSTUFF:
			if(((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->ERRCR.STUFF_ERR)	
				return 1;
			break;
	
		case DRVCAN_ERRFORM:
			if(((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->ERRCR.FORM_ERR)	
				return 1;
			break;

		case DRVCAN_ERRCRC:
			if(((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->ERRCR.CRC_ERR)	
				return 1;
			break;
			  
		case DRVCAN_ERRACK:
			if(((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->ERRCR.ACK_ERR)	
				return 1;
			break;
			
		case DRVCAN_ERRBIT:
			if(((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->ERRCR.BIT_ERR)	
				return 1;
			break;
...
int32_t DrvCAN_SetAcceptanceFilter(int32_t id_Filter )
{
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->ACR.ACRID =id_Filter;	
...
int32_t DrvCAN_SetMaskFilter(int32_t id_Filter )
{
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->AMR.AMRID =id_Filter;	
...
)
{
	...
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->BTIMR.SJW 	= i8SynJumpWidth;
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->BTIMR.TSEG1 	= i16TimeSeg1;
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->BTIMR.TSEG2 	= i8TimeSeg2;
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->BTIMR.SAMP 	= i8SampPtNo;
...
int32_t DrvCAN_GetClockFreq(void)
{
	...
	if(((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1.CAN_S == 0)			
	{
		clk = DrvSYS_GetExtClockFreq();			 
	}
	else if(((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1.CAN_S == 1)
	{
...
int32_t DrvCAN_GetTxErrorCount(void)
{
	return ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->TECNTR.TECNT;
...
int32_t DrvCAN_GetRxErrorCount(void)
{
	return ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->RECNTR.RECNT;
...
void DrvCAN_ReTransmission(int32_t bIsEnable)
{
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->CMD.ABRT = bIsEnable?1:0 ;
}
