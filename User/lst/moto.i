...
{
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->POE.PWM0 = 0;
	...
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR0 = u1;
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR1 = u2;	
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR2 = u3;
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR3 = u4;
...
void moto_close()
{
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPAMFP.PWM0_AD13 = 0;
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPAMFP.PWM1_AD14 = 0;
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPAMFP.PWM2_AD15 = 0;
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPAMFP.PWM3_I2SMCLK = 0;
