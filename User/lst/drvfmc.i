#line 1 "..\\BSP_Lib\\Src\\Driver\\DrvFMC.c"
...
#line 7 "..\\BSP_Lib\\Src\\Driver\\DrvFMC.c"
#line 1 "..\\BSP_Lib\\Inc\\Driver\\DrvFMC.h"
...
#line 10 "..\\BSP_Lib\\Inc\\Driver\\DrvFMC.h"
...
#line 8 "..\\BSP_Lib\\Src\\Driver\\DrvFMC.c"
...
#line 9 "..\\BSP_Lib\\Src\\Driver\\DrvFMC.c"
...
void DrvFMC_EnableLowSpeedMode(void)
{	
	((FMC_T *) ((( uint32_t)0x50000000) + 0x0C000))->FATCON.L_SPEED = 1;
}
...
void DrvFMC_DisableLowSpeedMode(void)
{	
	((FMC_T *) ((( uint32_t)0x50000000) + 0x0C000))->FATCON.L_SPEED = 0;
}
...
int32_t DrvFMC_WriteConfig(uint32_t u32data0, uint32_t u32data1)
{		
	if ( !DrvFMC_Erase(0x00300000) )
		return (((1) ? 0xFFFF0000 : 0x00000000) | ((((MODULE_ID_DRVFMC) & 0xFF) | ((1) ? 0x100 : 0x00)) << 7) | ((1) & 0x7F));
	
	if ( !DrvFMC_Write(0x00300000, u32data0) )
		return (((1) ? 0xFFFF0000 : 0x00000000) | ((((MODULE_ID_DRVFMC) & 0xFF) | ((1) ? 0x100 : 0x00)) << 7) | ((1) & 0x7F));
