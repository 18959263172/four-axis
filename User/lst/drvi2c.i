#line 1 "..\\BSP_Lib\\Src\\Driver\\DrvI2C.c"
...
#line 7 "..\\BSP_Lib\\Src\\Driver\\DrvI2C.c"
#line 1 "..\\BSP_Lib\\Inc\\Driver\\DrvI2C.h"
...
#line 10 "..\\BSP_Lib\\Inc\\Driver\\DrvI2C.h"
...
#line 8 "..\\BSP_Lib\\Src\\Driver\\DrvI2C.c"
...
void I2C0_IRQHandler(void)
{
    ...
    if (((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->TOC.TIF)
	{
		((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->TOC.TIF = 1;	 
...
void I2C1_IRQHandler(void)
{
    ...
    if (((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->TOC.TIF)
	{
		((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->TOC.TIF = 1;	 
...
void DrvI2C_Ctrl(E_I2C_PORT port, uint8_t start, uint8_t stop, uint8_t intFlag, uint8_t ack)
{
	...
	if (port)
		*((volatile uint32_t *)&((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON) = (*((volatile uint32_t *)&((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON) & ~0x3C) | Reg;
	else
		*((volatile uint32_t *)&((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->CON) = (*((volatile uint32_t *)&((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->CON) & ~0x3C) | Reg;	    	
}
...
void DrvI2C_WriteData(E_I2C_PORT port, uint8_t u8data)
{
	...
	{
		((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->DATA = u8data;	
	}
}
...
uint8_t DrvI2C_ReadData(E_I2C_PORT port)
{
	if (port)
	{						   
		return ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->DATA;
	}	
	else
	{
		return ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->DATA;	
	}
}
...
uint8_t DrvI2C_GetIntFlag(E_I2C_PORT port)
{
	if (port)
	{						   
		return ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.SI;
	}	
	else
	{
		return ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->CON.SI;	
	}
}
...
void DrvI2C_ClearIntFlag(E_I2C_PORT port)
{
	if (port)
	{						   
		((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.SI = 1;
	}	
	else
	{
		((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->CON.SI = 1;	
	}	    	
}
...
uint32_t DrvI2C_GetStatus(E_I2C_PORT port)
{
	if (port)
	{
		return ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->STATUS;
	}
	else
	{
		return ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->STATUS;
	}	
}
...
int32_t DrvI2C_Open(E_I2C_PORT port, uint32_t u32BusClock)
{
    ...
    if (port)
	{
		...
		((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.ENSI = 1;
		((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CLK = divider;
	}
	else
	{
		...
		((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->CON.ENSI = 1;
		((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->CLK = divider;
	}
...
int32_t DrvI2C_Close(E_I2C_PORT port)
{
    if (port)
	{
		((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.ENSI = 0;
		((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2.I2C1_RST = 1;
		((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2.I2C1_RST = 0;
	...
	{
		((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->CON.ENSI = 0;
		((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2.I2C0_RST = 1;
		((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2.I2C0_RST = 0;
...
uint32_t DrvI2C_GetClockFreq(E_I2C_PORT port)
{
	...
	divider = ( (port)? ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CLK:((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->CLK );
...
int32_t DrvI2C_EnableInt(E_I2C_PORT port)
{
    if (port)
	{
		((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.EI = 1;
		NVIC_EnableIRQ(I2C1_IRQn);
	}
	else
	{
	    ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->CON.EI = 1;
...
int32_t DrvI2C_DisableInt(E_I2C_PORT port)
{
    if (port)
	{
		((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.EI = 0;
		NVIC_DisableIRQ(I2C1_IRQn);
	}
	else
	{
	    ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->CON.EI = 0;
...
int32_t DrvI2C_SetTimeoutCounter(E_I2C_PORT port, int32_t i32enable, uint8_t u8div4)
{
    if (port)
	{
		((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->TOC.DIV4 = u8div4;
		((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->TOC.ENTI = i32enable;
	}
	else
	{
	    ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->TOC.DIV4 = u8div4;
		((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->TOC.ENTI = i32enable;
	}
	return 0;
}
...
int32_t DrvI2C_SetAddress(E_I2C_PORT port, uint8_t slaveNo, uint8_t slave_addr, uint8_t GC_Flag)
{
	if (port)
	{
		...
		{
			case 0:
				((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->ADDR0.ADDR = slave_addr;
				((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->ADDR0.GC   = GC_Flag;
				break;
			case 1:
				((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->ADDR1.ADDR = slave_addr;
				((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->ADDR1.GC   =	GC_Flag;
				break;
			case 2:
				((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->ADDR2.ADDR = slave_addr;
				((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->ADDR2.GC   =	GC_Flag;
				break;
			case 3:
				((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->ADDR3.ADDR = slave_addr;
				((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->ADDR3.GC   =	GC_Flag;
				break;
			default:
	...
	else
	{
		...
		{
			case 0:
				((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->ADDR0.ADDR  = slave_addr;
				((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->ADDR0.GC    = GC_Flag;
				break;
			case 1:
				((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->ADDR1.ADDR = slave_addr;
				((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->ADDR1.GC   =	GC_Flag;
				break;
			case 2:
				((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->ADDR2.ADDR = slave_addr;
				((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->ADDR2.GC   =	GC_Flag;
				break;
			case 3:
				((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->ADDR3.ADDR = slave_addr;
				((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->ADDR3.GC   =	GC_Flag;
				break;
			default:
				return (((1) ? 0xFFFF0000 : 0x00000000) | ((((MODULE_ID_DRVI2C) & 0xFF) | ((1) ? 0x100 : 0x00)) << 7) | ((1) & 0x7F));
		}	
...
int32_t DrvI2C_SetAddressMask(E_I2C_PORT port, uint8_t slaveNo, uint8_t slaveAddrMask)
{
	...
	if (port)
	{
		...
		{
			case 0:
				((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->ADRM0.ADM = slaveAddrMask;
				break;
			case 1:
				((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->ADRM1.ADM = slaveAddrMask;
				break;
			case 2:
				((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->ADRM2.ADM = slaveAddrMask;
				break;
			case 3:
				((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->ADRM3.ADM = slaveAddrMask;
				break;
			default:
				return (((1) ? 0xFFFF0000 : 0x00000000) | ((((MODULE_ID_DRVI2C) & 0xFF) | ((1) ? 0x100 : 0x00)) << 7) | ((1) & 0x7F));
		}
	...
	else
	{
		...
		{
			case 0:
				((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->ADRM0.ADM = slaveAddrMask;
				break;
			case 1:
				((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->ADRM1.ADM = slaveAddrMask;
				break;
			case 2:
				((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->ADRM2.ADM = slaveAddrMask;
				break;
			case 3:
				((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->ADRM3.ADM = slaveAddrMask;
				break;
			default:
				return (((1) ? 0xFFFF0000 : 0x00000000) | ((((MODULE_ID_DRVI2C) & 0xFF) | ((1) ? 0x100 : 0x00)) << 7) | ((1) & 0x7F));
		}	
