...
#line 3 "Smpl_DrvGPIO.c"
#line 1 "..\\BSP_Lib\\Inc\\Driver\\DrvADC.h"
...
#line 14 "..\\BSP_Lib\\Inc\\Driver\\DrvADC.h"
#line 1 "..\\BSP_Lib\\Inc\\Driver\\System/SysInfra.h"
...
#line 73 "..\\BSP_Lib\\Inc\\Driver\\System/SysInfra.h"



#line 15 "..\\BSP_Lib\\Inc\\Driver\\DrvADC.h"
...
#line 50 "..\\BSP_Lib\\Inc\\Driver\\DrvADC.h"
...
#line 45 "..\\BSP_Lib\\Inc\\Driver\\DrvUART.h"
...
#line 8 "Smpl_DrvGPIO.c"
#line 9 "Smpl_DrvGPIO.c"
...
#line 12 "Smpl_DrvGPIO.c"
#line 13 "Smpl_DrvGPIO.c"
#line 1 "mpu6050.h"
...
void PWM_OUT(int32_t port,int32_t period);                        
uint32_t DrvADC_SetSinOut(unsigned char u8Option);                      
...
unsigned char YM=0;              
int ich1=0,ich2=0,ich3=0,ich4=0,ich5=0,ich6=0;				 
int speed0=0,speed1=0,speed2=0,speed3=0,V=0;           
int PWM0=0,PWM1=0,PWM2=0,PWM3=0;  
int g_x=0,g_y=0,g_z=0;            
unsigned char TxBuf[20]={0};
unsigned char RxBuf[20]={0};  
double PID_x=0,PID_y=0,PID_z=0;  
float FR1=0,FR2=0,FR3=0;         

double Gyro_y=0,Gyro_x=0,Gyro_z=0;        
double Accel_x=0,Accel_y=0,Accel_z=0;	    
double Angle_ax=0,Angle_ay=0,Angle_az=0;  
double Angle_gy=0,Angle_gx=0,Angle_gz=0;  
double AngleAx=0,AngleAy=0;               
double Angle=0,Angley=0;                  
double Anglezlate=0;                      
double Ax=0,Ay=0;                         

float Out_PID_X=0,Last_Angle_gx=0;
float Out_XP=60,Out_XI=0.01,ERRORX_Out=0;
float In_XP=0.5,In_XI=0.01,In_XD=10,ERRORX_In=0;
...
{	
	...
	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x59;*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x16;*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x88;
	...
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL0.HCLK_S = 2;
	u32HCLK = DrvSYS_GetHCLKFreq();													 
	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x00;;															 
	...
	DrvTIMER_SetTimerEvent(E_TMR0, 10, (TIMER_CALLBACK)TMR0_Callback, 0);   
...
{	
	...
	else if(YM>RxBuf[4]&&(YM-RxBuf[4])<=2){YM--;YM--;}  
	else {YM=RxBuf[4];}
	Accel_y= GetData(0x3D);	
	Accel_x= GetData(0x3B);		   
	Accel_z= GetData(0x3F);	     
	Gyro_x = GetData(0x43)-g_x;
	Gyro_y = GetData(0x45)-g_y;
	Gyro_z = GetData(0x47)-g_z;	
...
void PWM23_Init()
{
	...
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CSR.CSR3 = 4;
	...
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CNR2 = 1090;
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR2 = 100;
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CNR3 = 1090;
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR3 = 100;
	
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CNR0 = 1090;
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR0 = 100;
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CNR1 = 1090;
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR1 = 100;
