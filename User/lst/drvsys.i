...
int32_t DrvSYS_IsProtectedRegLocked(void)
{
	return ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->REGLOCK & 0x01;
}
...
void DrvSYS_SetBODFunction(int32_t i32Enalbe, int32_t i32Mode, BOD_CALLBACK bodcallbackFn)
{
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->BODCR.BOD_EN = i32Enalbe;
...
void DrvSYS_EnableTemperatureSensor(void)
{
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->TEMPCR = 1;
}
...
void DrvSYS_DisableTemperatureSensor(void)
{
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->TEMPCR = 0;
}
...
int32_t DrvSYS_SetClockDivider(E_SYS_IP_DIV eIpDiv , int32_t i32value)
{
	...
	{
		((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKDIV.CAN_N     =  i32value & 0x00F;
		((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKDIV.CAN_N_EXT = (i32value & 0x3F0)>>4;
	}
...
{	
	...
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PWRCON.PWR_DOWN = 1;
}
...
void DrvSYS_Delay(uint32_t us)
{
	((SysTick_Type *) ((0xE000E000) + 0x0010))->LOAD = (us * (SystemCoreClock / 10000)) / 100;
