#line 1 "..\\BSP_Lib\\Src\\Driver\\DrvI2S.c"
...
#line 7 "..\\BSP_Lib\\Src\\Driver\\DrvI2S.c"
#line 1 "..\\BSP_Lib\\Inc\\Driver\\DrvI2S.h"
...
#line 10 "..\\BSP_Lib\\Inc\\Driver\\DrvI2S.h"
...
#line 60 "..\\BSP_Lib\\Inc\\Driver\\DrvI2S.h"
...
#line 8 "..\\BSP_Lib\\Src\\Driver\\DrvI2S.c"
...
#line 9 "..\\BSP_Lib\\Src\\Driver\\DrvI2S.c"
...
void I2S_IRQHandler(void)
{
	...
	u32Reg = (*((volatile unsigned int *)(&(((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->STATUS))));

	if (u32Reg & 0x00000004)
	{
		 
		if ((u32Reg & 0x00010000) && (((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->IE.TXUDFIE == 1))
		{
			if (I2SHandler.TxUnderflowFn)
				I2SHandler.TxUnderflowFn(u32Reg);
			
			*((volatile unsigned int *)(&(((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->STATUS)))=0x00010000;
		}
		 
		else if ((u32Reg & 0x00020000) && (((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->IE.TXOVFIE == 1))
		{
			if (I2SHandler.TxOverflowFn)
				I2SHandler.TxOverflowFn(u32Reg);
			
			*((volatile unsigned int *)(&(((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->STATUS)))=0x00020000;		
		}
		 
		else if ((u32Reg & 0x00400000) && (((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->IE.RZCIE == 1))
		{
			if (I2SHandler.TxRightZeroCrossFn)
				I2SHandler.TxRightZeroCrossFn(u32Reg);
			*((volatile unsigned int *)(&(((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->STATUS)))=0x00400000;		
		}
		 
		else if ((u32Reg & 0x00800000) && (((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->IE.LZCIE == 1))
		{
			if (I2SHandler.TxLeftZeroCrossFn)
				I2SHandler.TxLeftZeroCrossFn(u32Reg);
			*((volatile unsigned int *)(&(((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->STATUS)))=0x00800000;		
		}						  
		 
		else if (((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->IE.TXTHIE == 1)
		{
	...
	else if (u32Reg & 0x00000002)
	{
		...
		if ((u32Reg & 0x00000100) && (((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->IE.RXUDFIE == 1))
		{
			if (I2SHandler.RxUnderflowFn)
				I2SHandler.RxUnderflowFn(u32Reg);
			
			*((volatile unsigned int *)(&(((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->STATUS)))=0x00000100;				
		}
		 
		else if ((u32Reg & 0x00000200) && (((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->IE.RXOVFIE == 1))
		{
			if (I2SHandler.RxOverflowFn)
				I2SHandler.RxOverflowFn(u32Reg);

			*((volatile unsigned int *)(&(((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->STATUS)))=0x00000200;			
		}
		 
		else if (((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->IE.RXTHIE == 1)
		{
...
int32_t DrvI2S_Open(S_DRVI2S_DATA_T *sParam)
{
	...
	((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->CON.WORDWIDTH 	= sParam->u8WordWidth;
	((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->CON.MONO 		= sParam->u8AudioFormat;
	((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->CON.FORMAT 	= sParam->u8DataFormat;
	((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->CON.SLAVE 		= sParam->u8Mode;
	((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->CON.TXTH 		= sParam->u8TxFIFOThreshold;
	((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->CON.RXTH 		= sParam->u8RxFIFOThreshold - 1;
	...
	((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->CLKDIV.BCLK_DIV = u8Divider;	
	
	((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->CON.I2SEN = 1;	
...
void DrvI2S_Close(void)
{
	((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->CON.I2SEN = 0;
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2.I2S_RST = 1;
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2.I2S_RST = 0;
...
int32_t DrvI2S_EnableInt(E_I2S_CALLBACK_TYPE Type, I2S_CALLBACK callbackfn)
{
	...
	*((volatile unsigned int *)(&(((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->IE)))=(*((volatile unsigned int *)(&(((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->IE)))) | (1<<Type);	
...
uint32_t DrvI2S_GetBCLKFreq(void)
{
	...
	u32Reg = ((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->CLKDIV.BCLK_DIV;
...
uint32_t DrvI2S_GetMCLKFreq(void)
{
	...
	u32Reg = ((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->CLKDIV.MCLK_DIV;
...
void DrvI2S_SetMCLKFreq(uint32_t u32Mclk)
{
	...
	((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->CLKDIV.MCLK_DIV = u8Divider;
}
...
int32_t DrvI2S_SetChannelZeroCrossDetect(E_I2S_CHANNEL channel, int32_t i32flag)
{
	...
	{
		((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->CON.LCHZCEN = i32flag;
	}
	else if (channel == I2S_RIGHT_CHANNEL)
	{
		((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->CON.RCHZCEN = i32flag;
	}
	else
		return (((1) ? 0xFFFF0000 : 0x00000000) | ((((MODULE_ID_DRVI2S) & 0xFF) | ((1) ? 0x100 : 0x00)) << 7) | ((1) & 0x7F));
...
void DrvI2S_EnableTxDMA(void)
{	
	((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->CON.TXDMA = 1;
}
...
void DrvI2S_DisableTxDMA(void)
{	
	((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->CON.TXDMA = 0;
}
...
void DrvI2S_EnableRxDMA(void)
{
	((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->CON.RXDMA = 1;	
}
...
void DrvI2S_DisableRxDMA(void)
{
	((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->CON.RXDMA = 0;	
}
...
void DrvI2S_EnableTx(void)
{
	((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->CON.TXEN = 1;
}
...
void DrvI2S_DisableTx(void)
{
	((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->CON.TXEN = 0;
}
...
void DrvI2S_EnableRx(void)
{
	((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->CON.RXEN = 1;	
}
...
void DrvI2S_EnableTxMute(void)
{
	((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->CON.MUTE = 1;	
}
...
void DrvI2S_DisableTxMute(void)
{
	((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->CON.MUTE = 0;	
}
...
void DrvI2S_EnableMCLK(void)
{	
	((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->CON.MCLKEN = 1;
}
...
void DrvI2S_DisableMCLK(void)
{	
	((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->CON.MCLKEN = 0;
}
...
void DrvI2S_ClearTxFIFO(void)
{
	((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->CON.CLR_TXFIFO = 1;
}
...
void DrvI2S_ClearRxFIFO(void)
{
	((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->CON.CLR_RXFIFO = 1;
}
