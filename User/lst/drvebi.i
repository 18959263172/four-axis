#line 1 "..\\BSP_Lib\\Src\\Driver\\DrvEBI.c"
...
#line 7 "..\\BSP_Lib\\Src\\Driver\\DrvEBI.c"
...
#line 8 "..\\BSP_Lib\\Src\\Driver\\DrvEBI.c"
...
#line 9 "..\\BSP_Lib\\Src\\Driver\\DrvEBI.c"
#line 1 "..\\BSP_Lib\\Inc\\Driver\\DrvEBI.h"
...
#line 10 "..\\BSP_Lib\\Inc\\Driver\\DrvEBI.h"
...
#line 10 "..\\BSP_Lib\\Src\\Driver\\DrvEBI.c"
...
void DrvEBI_Close(void)
{
	...
	((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->CON.ExtEN = 0;
...
void DrvEBI_SetBusTiming(DRVEBI_TIMING_T sEBITiming)
{	
	((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->CON.MCLKDIV = sEBITiming.eMCLKDIV;
	((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->CON.ExttALE = sEBITiming.u8ExttALE;
	
	((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->TIME.ExttACC = sEBITiming.u8ExttACC;
	((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->TIME.ExttAHD = sEBITiming.u8ExttAHD;
	((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->TIME.ExtIW2X = sEBITiming.u8ExtIW2X;
	((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->TIME.ExtIR2W = sEBITiming.u8ExtIR2W;
	((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->TIME.ExtIR2R = sEBITiming.u8ExtIR2R;
}
...
void DrvEBI_GetBusTiming(DRVEBI_TIMING_T *psEBITiming)
{
	psEBITiming->eMCLKDIV  = (E_DRVEBI_MCLKDIV)((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->CON.MCLKDIV;
	psEBITiming->u8ExttALE = ((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->CON.ExttALE;
	
	psEBITiming->u8ExttACC = ((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->TIME.ExttACC;
	psEBITiming->u8ExttAHD = ((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->TIME.ExttAHD;
	psEBITiming->u8ExtIW2X = ((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->TIME.ExtIW2X;
	psEBITiming->u8ExtIR2W = ((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->TIME.ExtIR2W;
	psEBITiming->u8ExtIR2R = ((EBI_T *) ((( uint32_t)0x50000000) + 0x10000))->TIME.ExtIR2R;
}
