...
{
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPAMFP.I2C1_SCL_nRD = 1;
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPAMFP.I2C1_SDA_nWR = 1;
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->APBCLK.I2C1_EN = 1;	 

	((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CLK=100;
...
int MPU_WriteReg( char RegAddr, char pucDATD_AA)
{
	...
	while(i<32) i++;	   
    ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.STA=1;         			    
    while (((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.SI==0);
    if (((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->STATUS != 0x08)	            
    {
       	printf("I2CD_STArt fail,I2D_STATUS %02X\r\n",((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->STATUS);
				return 0;
    }	        
	((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.SI=1;              			
    
    ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->DATA = 0xd0;
    while (((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.SI==0);
    if (((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->STATUS != 0x18)              
    {
	    printf("I2C write ADW fail\r\n");
	    return 0;
    }
	    ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.STA=0;  
	((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.SI=1; 
	
    ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->DATA = RegAddr;
    while (((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.SI==0);
    if (((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->STATUS!= 0x28)              
    {
	...
	((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->DATA = pucDATD_AA;  
	...
	((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.SI=1; 
    ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.STO=1;
	while(((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.STO==1)   ;     
...
char MPU_ReadReg( int unAddr )
{
    ...
    ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->DATA = unAddr;
    ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.SI=1; 
    while (((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.SI==0);
    if (((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->STATUS!= 0x28)              
    {
    ...
    ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.SI=1;  
	 ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.STA=1;                         	
    while (((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.SI==0);    
  if (((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->STATUS != 0x10)                      	
    {
    ...
    ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->DATA = 0xd0 | 1;
    while (((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.SI==0);	    
    if (((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->STATUS != 0x40)              
    {					
        printf("I2C write control fail\r\n");
        while (1);
    }
	...
	((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.SI=1; 
	while (((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.SI==0);
	if (((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->STATUS != 0x58)              
	{
	   printf("I2C read fail\r\n");
	   return 0;
	}		
	ret = ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->DATA;	
    ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.AA=0;
    ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.SI=1; 
    while (((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.SI==0);  
    
    ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.STO=0;
    ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.SI=1;
    while (((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.STO==1);                      
		return ret;
}
...
int MPU_ReadBuf( int unAddr, char *pucDATD_AA, int unLength)
{
    ...
    while (((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.SI==0);	        
    ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.STA=0;           	
		((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.SI=0;  
    ...
    ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->DATA = 0x68 | 0x69;
    ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.SI=1;
    while (((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.SI!=0);
    if (((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->STATUS != 0x18)              
    {
    ...
    ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->DATA = 0x68 | 1;
    ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.SI=1;
    while (((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.SI==0);	    
    if (((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->STATUS != 0x40)              
    {
	...
	((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.AA= 1;
	for(i=0; i<unLength; i++)
	{
		((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.SI=1; 
		while (((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->CON.SI==0);
		if (((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->STATUS != 0x50)              
		{
		   printf("I2C read fail\r\n");
		   return 0;
		}		
		*(pucDATD_AA+i) = ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->DATA;	
	} 	   
