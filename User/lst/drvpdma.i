#line 1 "..\\BSP_Lib\\Src\\Driver\\DrvPDMA.c"
...
#line 7 "..\\BSP_Lib\\Src\\Driver\\DrvPDMA.c"
...
#line 8 "..\\BSP_Lib\\Src\\Driver\\DrvPDMA.c"

 
 
 
#line 1 "..\\BSP_Lib\\Inc\\Driver\\DrvPDMA.h"
...
#line 13 "..\\BSP_Lib\\Inc\\Driver\\DrvPDMA.h"
...
#line 13 "..\\BSP_Lib\\Src\\Driver\\DrvPDMA.c"
...
{  
	...
	switch(eDevice)
	{
		...
		case eDRVPDMA_ADC:													 
			if(eRWAPB)	
				((PDMA_GCR_T *) ((( uint32_t)0x50000000) + 0x08F00))->PDSSR1.ADC_TXSEL	=	eChannel;
			else
...
int32_t DrvPDMA_GetCHForAPBDevice(E_DRVPDMA_APB_DEVICE eDevice,E_DRVPDMA_APB_RW eRWAPB)
{
	...
	switch(eDevice)
	{
		...
		case eDRVPDMA_ADC:													 
			if(eRWAPB)	
				return ((PDMA_GCR_T *) ((( uint32_t)0x50000000) + 0x08F00))->PDSSR1.ADC_TXSEL;
			else
